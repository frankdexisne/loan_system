...
<script>
    $(document).ready(function(){
        ...
        _columns = [
            {data : 'loan.transaction_code', title : '#'},
            {data : 'loan.client', title : 'Name', render(data){
            ...
            {data: 'loan', title : 'Details', render(data){
                return '<small> Category : ' + data['category']['name'] + '<br>' +
                       'Terms : ' + data['term']['name'] + '</small>';
            }},
            {data : 'loan.loan_amount', title : 'Loan Amount'},
            {data : 'loan.balance', title : 'Balance'},
            {data : null, title : 'Action', render(data,type){
                return '<div class="action-buttons">'+
							'<a class="green edit-1" href="#">'+
        ...
        $('#payment_mode_id').change(function(){
            ...
            datatable.off('click','.edit-1')
                .on('click','.edit-1',function(){
                    $tr = $(this).closest('tr');
